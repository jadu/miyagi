...
var ConversationService = /** @class */ (function () {
    function ConversationService(humanManager, logger, slackChannelService, messageService) {
        this.humanManager = humanManager;
        this.logger = logger;
        this.slackChannelService = slackChannelService;
        this.messageService = messageService;
    }
    ConversationService.prototype.goodbye = function (userName, channelId, message) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.slackChannelService.updateMessage(message.ts, channelId, this.messageService.endConversation(message))];
                    case 2: 
